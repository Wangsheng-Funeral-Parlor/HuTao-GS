...
export default class Server {
  ...
  async resourceCache() {
    logger.info('message.cache.info.start')
    ...
    logger.debug('message.cache.debug.gadget')
    await GrowCurveData.getData()
    logger.debug('message.cache.debug.growCurve')
    await MapAreaData.getData()
    logger.debug('message.cache.debug.mapArea')
    await MaterialData.getData()
    logger.debug('message.cache.debug.material')
    await MonsterData.getData()
    logger.debug('message.cache.debug.monster')
    await ReliquaryData.getData()
    logger.debug('message.cache.debug.reliquary')
    await SceneData.getData()
    logger.debug('message.cache.debug.scene')
    await ShopData.getData()
    logger.debug('message.cache.debug.shop')
    await SkillData.getData()
    logger.debug('message.cache.debug.skill')
    await TalentData.getData()
    logger.debug('message.cache.debug.talent')
    await WeaponData.getData()
    logger.debug('message.cache.debug.weapon')
    await WeatherData.getData()
    logger.debug('message.cache.debug.weather')
    await WorldData.getData()
    logger.debug('message.cache.debug.world')

    logger.info('message.cache.info.success')
  }
}