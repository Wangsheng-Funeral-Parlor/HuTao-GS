export enum MotionStateEnum {
  ...
  MOTION_NUM = 56,
  MOTION_UNK_57 = 57,
  MOTION_AQUATIC_DIVE_IDLE = 58,
  MOTION_AQUATIC_DIVE_MOVE = 59,
  MOTION_AQUATIC_DIVE_DASH = 60,
  MOTION_UNK_61 = 61,
  MOTION_UNK_62 = 62,
  MOTION_UNK_63 = 63,
  MOTION_AQUATIC_SWIM_MOVE = 64,
  MOTION_AQUATIC_SWIM_IDLE = 65,
  MOTION_AQUATIC_SWIM_DASH = 66
}